...
// store/editorStore.ts
var useEditorStore = (0, import_zustand.create)()((set, get) => __spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues({}, createTimelineSlice(set, get)), createPlaybackSlice(set)), createEffectsSlice(
  set,
  get
...
function TopBar() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center h-11 px-3 shrink-0 border-b border-white/[0.06]", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center gap-1 mx-auto", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "text-xs text-zinc-300 font-medium w-10 text-center tabular-nums", children: [
        zoomPercent,
        "%"
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
...
function Sidebar({ activeTool, onToolChange }) {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "flex flex-col w-[72px] shrink-0 border-r border-white/[0.06] py-2 gap-1", children: TOOLS.map((tool) => {
...
function CropOverlay() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
    "div",
    {
      ...
      style: { zIndex: 20 },
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "absolute pointer-events-none", style: { top: 0, left: 0, right: 0, height: `${y}%`, background: "rgba(0,0,0,0.55)" } }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "absolute pointer-events-none", style: { bottom: 0, left: 0, right: 0, height: `${100 - y - h}%`, background: "rgba(0,0,0,0.55)" } }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "absolute pointer-events-none", style: { top: `${y}%`, left: 0, width: `${x}%`, height: `${h}%`, background: "rgba(0,0,0,0.55)" } }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "absolute pointer-events-none", style: { top: `${y}%`, right: 0, width: `${100 - x - w}%`, height: `${h}%`, background: "rgba(0,0,0,0.55)" } }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          "div",
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "absolute inset-0 pointer-events-none", style: { opacity: 0.3 }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "absolute bg-white/50", style: { left: "33.3%", top: 0, bottom: 0, width: 1 } }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "absolute bg-white/50", style: { left: "66.6%", top: 0, bottom: 0, width: 1 } }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "absolute bg-white/50", style: { top: "33.3%", left: 0, right: 0, height: 1 } }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "absolute bg-white/50", style: { top: "66.6%", left: 0, right: 0, height: 1 } })
            ] })
          }
        ),
      ...
      children: hasClips ? /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
          "div",
          {
            ...
            children: [
              ...
              !previewReady && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "absolute inset-0 flex items-center justify-center bg-black z-10", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "w-8 h-8 border-2 border-zinc-600 border-t-zinc-300 rounded-full animate-spin" }) }),
        ...
        audioBlocked && !isMuted && /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
          import_framer_motion2.motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("svg", { className: "w-3.5 h-3.5 text-amber-400 shrink-0", fill: "currentColor", viewBox: "0 0 20 20", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("path", { fillRule: "evenodd", d: "M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z", clipRule: "evenodd" }) }),
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "w-12 h-12 rounded-full bg-white/10 flex items-center justify-center group-hover:bg-white/15 transition-colors", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("svg", { className: "w-6 h-6 text-zinc-300", fill: "none", stroke: "currentColor", strokeWidth: 1.5, viewBox: "0 0 24 24", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5m-13.5-9L12 3m0 0l4.5 4.5M12 3v13.5" }) }) }),
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "text-center", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { className: "text-sm font-medium text-zinc-200", children: "Import a video" }),
                    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { className: "text-xs text-zinc-500 mt-0.5", children: "or drag and drop anywhere" })
                  ] })
                ]
              }
            ),
...
function TrimPanel() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
    "div",
    {
      ...
      children: [
        (!clip || containerWidth === 0) && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "flex items-center justify-center", style: { height: TOTAL_H }, children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("p", { className: "text-xs text-zinc-600", children: clips.length === 0 ? "Import a video to trim" : "Loading\u2026" }) }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
            "div",
            {
              ...
              children: rulerTicks.map(({ t, isMajor }) => /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "absolute top-0 flex flex-col", style: { left: toX(t) }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: `w-px ${isMajor ? "h-2.5 bg-zinc-500" : "h-1.5 bg-zinc-700"}` }),
                isMajor && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "text-[9px] text-zinc-500 ml-1 leading-none tabular-nums", children: formatTime(t) })
              ] }, t))
            }
          ),
            ...
            "div",
            {
              ...
              children: [
                thumbs.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "flex h-full pointer-events-none", children: thumbs.map((src, i) => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
                  ...
                  i
                )) }) : /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "w-full h-full bg-zinc-900 flex items-center justify-center pointer-events-none", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "w-4 h-4 border-2 border-zinc-600 border-t-zinc-400 rounded-full animate-spin" }) }),
                (() => {
...
function SliderRow({ label, value, min, max, onValueChange, onPointerDown, displayValue }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "flex items-center gap-3", children: [
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: "text-xs text-zinc-400 w-20 shrink-0", children: label }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "relative flex-1 h-5 flex items-center", children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "absolute inset-x-0 h-1 rounded-full bg-zinc-700", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "h-full rounded-full bg-white/60", style: { width: `${pct}%` } }) }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: "text-xs text-zinc-400 w-8 text-right tabular-nums shrink-0", children: displayValue != null ? displayValue : value })
  ] });
}
function FinetunePanel() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "shrink-0 border-t border-white/[0.06] bg-[#1a1a1a] px-6 py-4", style: { height: 180 }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "flex items-center justify-between mb-3", children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: "text-xs font-semibold text-zinc-300 uppercase tracking-wider", children: "Adjustments" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "grid grid-cols-2 gap-x-8 gap-y-2.5", children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
        SliderRow,
        {
          label: "Brightness",
...
function FilterPanel() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "shrink-0 border-t border-white/[0.06] bg-[#1a1a1a] px-4 py-3", style: { height: 120 }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "flex items-center justify-between mb-2.5", children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: "text-xs font-semibold text-zinc-300 uppercase tracking-wider", children: "Filters" }) }),
...
function CropPanel() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "shrink-0 border-t border-white/[0.06] bg-[#1a1a1a] px-5 py-3", style: { height: 100 }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "flex items-center justify-between mb-2.5", children: [
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { className: "text-[10px] font-semibold text-zinc-500 uppercase tracking-wider", children: "Aspect Ratio" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("p", { className: "text-[10px] text-zinc-600 mt-2", children: "Drag handles in preview to adjust crop freely" })
  ] });
}
...
function ResizePanel() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "shrink-0 border-t border-white/[0.06] bg-[#1a1a1a] px-5 py-3", style: { height: 120 }, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "flex gap-8", children: [
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "flex-1", children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { className: "text-[10px] font-semibold text-zinc-500 uppercase tracking-wider", children: "Resolution" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "flex-1", children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { className: "text-[10px] font-semibold text-zinc-500 uppercase tracking-wider", children: "Frame Rate" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "flex-1", children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { className: "text-[10px] font-semibold text-zinc-500 uppercase tracking-wider", children: "Format" }),
...
function AnnotatePanel() {
  ...
  const clearStrokes = useEditorStore((s) => s.clearStrokes);
  const strokes = useEditorStore((s) => s.strokes);
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "shrink-0 border-t border-white/[0.06] bg-[#1a1a1a] px-5 py-3", style: { height: 90 }, children: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "flex items-center gap-6 h-full", children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "flex flex-col gap-1", children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "text-[9px] font-semibold text-zinc-500 uppercase tracking-wider", children: "Tool" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "flex flex-col gap-1", children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "text-[9px] font-semibold text-zinc-500 uppercase tracking-wider", children: "Color" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "flex flex-col gap-1", children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "text-[9px] font-semibold text-zinc-500 uppercase tracking-wider", children: "Width" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "flex flex-col gap-1 ml-auto", children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "text-[9px] font-semibold text-zinc-500 uppercase tracking-wider", children: "Actions" }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "flex gap-1", children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
          "button",
          {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "flex gap-4 h-full", children: [
        /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "flex-1 min-w-0 overflow-y-auto", children: [
          ...
          STICKER_GROUPS.map((group) => /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "mb-2", children: [
            /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("span", { className: "text-[10px] font-semibold text-zinc-600 uppercase tracking-wider block mb-1", children: group.label }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "w-36 shrink-0 flex flex-col gap-1.5", children: [
          /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("span", { className: "text-[10px] font-semibold text-zinc-500 uppercase tracking-wider", children: [
            "Active (",
            stickerOverlays.length,
            ")"
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "flex flex-col gap-1 overflow-y-auto", children: [
            stickerOverlays.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("span", { className: "text-[11px] text-zinc-600", children: "Click to add stickers" }),
...
function Editor() {
  const [activeTool, setActiveTool] = (0, import_react13.useState)("trim");
  ...
  const { status: exportStatus, progress: exportProgress, outputUrl } = useEditorStore(
    (0, import_shallow3.useShallow)((s) => ({ status: s.status, progress: s.progress, outputUrl: s.outputUrl }))
  );
  const resetExport = useEditorStore((s) => s.resetExport);
  const isExporting = exportStatus === "preparing" || exportStatus === "encoding";
  ...
  const handleToolChange = (0, import_react13.useCallback)((tool) => {
    setActiveTool(tool);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(
    "div",
    {
      ...
      onDrop,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(import_framer_motion3.AnimatePresence, { children: showOverlay && /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
          import_framer_motion3.motion.div,
          {
            ...
            children: isExportDone ? /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(import_jsx_runtime15.Fragment, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { className: "w-10 h-10 flex items-center justify-center rounded-full bg-emerald-500/20", children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("svg", { className: "w-5 h-5 text-emerald-400", fill: "none", stroke: "currentColor", strokeWidth: 2.5, viewBox: "0 0 24 24", children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M5 13l4 4L19 7" }) }) }),
              /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("p", { className: "text-sm font-semibold text-white", children: "Export complete" }),
              /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { className: "flex items-center gap-3 mt-1", children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("p", { className: "text-sm font-semibold text-white", children: "Exporting\u2026" }),
              /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { className: "w-64 h-1.5 bg-zinc-700 rounded-full overflow-hidden", children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
                import_framer_motion3.motion.div,
                {
              ...
              /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("p", { className: "text-xs text-zinc-400 tabular-nums", children: [
                exportProgress,
                "%"
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
        ...
        /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { className: "flex flex-1 overflow-hidden min-h-0", children: [
          /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Sidebar, { activeTool, onToolChange: handleToolChange }),
          /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { className: "flex flex-col flex-1 overflow-hidden min-w-0", children: [
            /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(PreviewPanel, { activeTool }),
            /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(import_framer_motion3.AnimatePresence, { mode: "wait", initial: false, children: [
              activeTool === "trim" && /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
                import_framer_motion3.motion.div,
                {
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(TrimPanel, {})
                },
                "trim"
              ),
              activeTool === "finetune" && /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
                import_framer_motion3.motion.div,
                {
                  initial: { opacity: 0, y: 8 },
                  animate: { opacity: 1, y: 0 },
                  exit: { opacity: 0, y: 8 },
                  transition: { duration: 0.15 },
                  children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(FinetunePanel, {})
                },
                "finetune"
              ),
              activeTool === "filter" && /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
                import_framer_motion3.motion.div,
                {
                  initial: { opacity: 0, y: 8 },
                  animate: { opacity: 1, y: 0 },
                  exit: { opacity: 0, y: 8 },
                  transition: { duration: 0.15 },
                  children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(FilterPanel, {})
                },
                "filter"
              ),
              activeTool === "crop" && /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
                import_framer_motion3.motion.div,
                {
                  initial: { opacity: 0, y: 8 },
                  animate: { opacity: 1, y: 0 },
                  exit: { opacity: 0, y: 8 },
                  transition: { duration: 0.15 },
                  children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(CropPanel, {})
                },
                "crop"
              ),
              activeTool === "resize" && /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
                import_framer_motion3.motion.div,
                {
                  initial: { opacity: 0, y: 8 },
                  animate: { opacity: 1, y: 0 },
                  exit: { opacity: 0, y: 8 },
                  transition: { duration: 0.15 },
                  children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(ResizePanel, {})
                },
                "resize"
              ),
              activeTool === "annotate" && /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
                import_framer_motion3.motion.div,
                {
                  initial: { opacity: 0, y: 8 },
                  animate: { opacity: 1, y: 0 },
                  exit: { opacity: 0, y: 8 },
                  transition: { duration: 0.15 },
                  children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(AnnotatePanel, {})
                },
                "annotate"
              ),
              activeTool === "sticker" && /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
                import_framer_motion3.motion.div,
                {
                  initial: { opacity: 0, y: 8 },
                  animate: { opacity: 1, y: 0 },
                  exit: { opacity: 0, y: 8 },
                  transition: { duration: 0.15 },
                  children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(StickerPanel, {})
                },
                "sticker"
              )
            ] })
...
function kutlassEditor({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
    "div",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Editor, {})
    }
  );
}
